...
export default function SlidingToast({
	...
	return (
		<motion.div
			...
			className={`fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between w-full bg-gray-900 text-white p-3 shadow-xl border-b border-gray-800 overflow-hidden`}
		>
			<div className="flex items-center w-full overflow-hidden mr-4">
				...
				<div className="relative flex overflow-x-hidden w-full">
					<motion.div
						animate={{ x: ['100%', '-100%'] }} // -50% para mover metade do conteúdo
						transition={{
							repeat: Infinity,
							repeatType: 'loop',
							duration: 18,
